...
import 'package:restaurant_app/src/restaurant/model/restaurant_local.dart';
...
void main() async {
  ...
  test("Test Parsing Local Restaurant JSON First Restaurant ID", () {
    var result = RestaurantLocal.fromJson(json).restaurants.first.id;
    expect(result, "rqdv5juczeskfw1e867");
  });
  test("Test Parsing Local Restaurant JSON First Restaurant Name", () {
    var result = RestaurantLocal.fromJson(json).restaurants.first.name;
